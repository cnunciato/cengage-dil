...
namespace OnlineImageLibrary.WebUI.Controllers
{
    public class DataController : Controller
    {
        ...
        */
        ...
        {
            return Json(new SQLImagesRepository(ConfigurationManager.ConnectionStrings["appDB"].ConnectionString).Images.GroupBy(a => a.Artist).Distinct().ToArray(), JsonRequestBehavior.AllowGet);
        }
        */
